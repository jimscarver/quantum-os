...
export const CMD_HELP: Record<string, string[]> = {
  ...
  rholang: [
    ...
    "Both verbs open the same editor and it offers both actions: Evaluate (Ctrl+Enter) or Sign and deploy (Ctrl+Shift+Enter). The verb you typed only decides which is the blue button.",
...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  { label: "Rholang", ico: "⛓", kind: "command", cmd: "/rholang eval",
    hint: "write rholang and run it on an rnode — the editor offers both Evaluate and Sign-and-deploy, "
