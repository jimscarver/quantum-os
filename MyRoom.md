# My Room — [QuantumOS](https://github.com/jimscarver/quantum-os)
...
**→ [Open my room](https://jimscarver.github.io/quantum-os/#room=cap%3Aroom%3A05214747236101414325074505234721)**
...
1. **[Open the app](https://jimscarver.github.io/quantum-os/)** with no room in the URL — it
...
4. Tell them to **click Connect** when they arrive, and point them at the
   **[repo / README](https://github.com/jimscarver/quantum-os)** so they know what they're
   joining.
...
- **Found a bug or have an idea?** [Submit an issue](https://github.com/jimscarver/quantum-os/issues/new)
